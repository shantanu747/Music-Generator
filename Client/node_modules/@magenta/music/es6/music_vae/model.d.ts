...
declare class MusicVAE {
    ...
    decode(z: tf.Tensor2D, temperature?: number, chordProgression?: string[], stepsPerQuarter?: number, qpm?: number): Promise<INoteSequence[]>;
    private getInterpolatedZs;
    sample(numSamples: number, temperature?: number, chordProgression?: string[], stepsPerQuarter?: number, qpm?: number): Promise<INoteSequence[]>;
}
